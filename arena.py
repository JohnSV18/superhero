...
class Arena:
    ...
    def create_weapon(self):
        ...
        weapon = input("What is the max damage your new weapon can do? ")
        adding_weapon = Weapon(weapon)
    ...
    def create_armor(self):
        ...
        max_block = input("What is the max damage your armor can block?  ")
    ...
    def create_hero(self):
        ...
        while add_item != "4":
           ...
           if add_item == "1":
               ...
               ability_name = input('Abilitys name: ')
               ability_damage = input('What is the max damage your ability? ')
               hero.create_ability(ability_name, ability_damage)

           elif add_item == "2":
               #TODO add a weapon to the hero
               #HINT: First create the weapon, then add it to the hero
               weapon_name = input('Weapons name: ')
               weapon_damage = input('What is the max damage your weapon? ')
               hero.create_weapon(weapon_name, weapon_damage)


           elif add_item == "3":
               #TODO add an armor to the hero
               #HINT: First create the armor, then add it to the hero
               armor_name = input('Armors name: ')
               armor_block= input('What is the max block for your armor? ')
               hero.create_armor(armor_name, armor_block)
    ...
    def show_stats(self):
        ...
        for hero_two in self.team_two:
            survival = hero.is_alive()
            if survival is True:
                self.team_two.append(survival)
                print(f'{hero_two}')
        ...
        if hero_alive > hero_two_alive:
            print('Team one are the winners!')
        elif hero_two_alive > hero_alive:
            print('Team two are the winners!')
        #
